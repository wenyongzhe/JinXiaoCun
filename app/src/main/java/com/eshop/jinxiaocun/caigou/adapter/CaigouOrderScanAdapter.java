...
public class CaigouOrderScanAdapter extends BaseAdapter {

    private List<GetClassPluResult> listInfo;
    private LayoutInflater inflater = null;
    private int itemClickPosition = -1;

    public CaigouOrderScanAdapter(List<GetClassPluResult> listInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_caigou_order_scan,parent,false);
        }
