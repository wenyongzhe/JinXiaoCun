...
public class CaigouRucangScanAdapter extends BaseAdapter {

    private List<GetClassPluResult> listInfo;
    private LayoutInflater inflater = null;
    private int itemClickPosition = -1;

    public CaigouRucangScanAdapter(List<GetClassPluResult> listInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_caigou_rucang_scan,parent,false);
        }
        ...
        TextView tv_orderQty = ViewHolderUtils.get(convertView, R.id.tv_orderQty);
        ...
        tv_orderQty.setText(listInfo.get(position).getOrder_qnty()+listInfo.get(position).getUnit_no());
