...
public class CaigouRuCangListActivity extends CommonBaseListActivity implements INetWorResult {
    ...
    private CaigouRucangListAdapter mAdapter;
    ...
    protected int getLayoutContentId() {
        return R.layout.activity_caigou_rucang_list;
    }
    ...
    protected void initView() {
        ...
        mAdapter = new CaigouRucangListAdapter(mListInfo);
    ...
    private void getCaigouRucangData() {
        ...
        mDanJuMainBean.JsonData.sheettype = Config.YwType.PI.toString();//单据类型
    ...
    protected void createOrderAfter() {
        startActivityForResult(new Intent(this,CaigouRucangScanActivity.class),2);
    }
    ...
    protected void modifyAfter() {
        Intent intent = new Intent(this,CaigouRucangScanActivity.class);
    ...
    protected boolean checkBefore() {
        ...
        if(!CommonUtility.getInstance().havePermission(16)){
