...
public class JichiSaveResult implements Serializable{
    ...
    private String aprove;//”:”1”     //审核状态
    private String aprove_date;//”:” 2019-05-30 11：20：00”     //审核日期
    ...
    public String getAprove_date() {
        return aprove_date;
    }

    public void setAprove_date(String aprove_date) {
