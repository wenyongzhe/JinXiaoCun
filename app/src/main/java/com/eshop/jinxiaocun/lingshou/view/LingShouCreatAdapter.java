...
public class LingShouCreatAdapter extends MyBaseAdapter {
    ...
    public LingShouCreatAdapter(List<GetClassPluResult> listInfo) {
        this.listInfo = listInfo;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        sale_price.setText("售价￥"+MyUtils.formatFloat2(
        ...
        sale_total.setText("合计￥"+ MyUtils.formatFloat2(
                MyUtils.convertToFloat(listInfo.get(position).getSale_qnty(),0f)*
                        MyUtils.convertToFloat(listInfo.get(position).getSale_price(),0f))+"");
