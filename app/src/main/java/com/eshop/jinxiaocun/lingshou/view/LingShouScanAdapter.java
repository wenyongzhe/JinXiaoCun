...
public class LingShouScanAdapter extends MyBaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        sale_price.setText("售价￥"+MyUtils.formatFloat2(MyUtils.convertToFloat(listInfo.get(position).getSale_price(),0f)));
        ...
        sale_price_old.setText("原价￥"+MyUtils.formatFloat2(MyUtils.convertToFloat(listInfo.get(position).getSale_price_beforModify(),0f)));
        ...
        sale_total.setText("合计￥"+ MyUtils.formatFloat2(MyUtils.convertToFloat(listInfo.get(position).getSale_qnty(),0f)*
                MyUtils.convertToFloat(listInfo.get(position).getSale_price(),0f))+"");
