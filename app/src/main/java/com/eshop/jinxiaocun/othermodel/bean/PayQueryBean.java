 ...
 * Des
 */
public class PayQueryBean extends BaseBean {

    public PayQueryJsonData JsonData;
    public PayQueryBean (){
        setStrCmd(WebConfig.GETPAYQUERY);
        JsonData = new PayQueryJsonData();
    }

    public class PayQueryJsonData{
