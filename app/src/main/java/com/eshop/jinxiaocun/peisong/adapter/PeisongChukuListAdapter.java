...
public class PeisongChukuListAdapter extends BaseAdapter {
    ...
    public PeisongChukuListAdapter(List<DanJuMainBeanResultItem> listInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_peisong_chuku,parent,false);
        }
        ...
        tvStoreName.setText(listInfo.get(position).getYHShopName());
