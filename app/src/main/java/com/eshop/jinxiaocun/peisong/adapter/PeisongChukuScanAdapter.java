...
public class PeisongChukuScanAdapter extends BaseAdapter {

    private List<GetClassPluResult> listInfo;
    private LayoutInflater inflater = null;
    private int itemClickPosition = -1;

    public PeisongChukuScanAdapter(List<GetClassPluResult> listInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_peisong_chuku_scan,parent,false);
        }
