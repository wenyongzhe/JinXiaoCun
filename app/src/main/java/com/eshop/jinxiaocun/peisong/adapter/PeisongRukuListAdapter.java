...
public class PeisongRukuListAdapter extends BaseAdapter {
    ...
    public PeisongRukuListAdapter(List<DanJuMainBeanResultItem> listInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_peisong_ruku,parent,false);
        }
