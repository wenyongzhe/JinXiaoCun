...
public class YaohuoOrderListActivity extends CommonBaseListActivity implements INetWorResult {
    ...
    private YaohuoOrderListAdapter mAdapter;
    ...
    protected int getLayoutContentId() {
        return R.layout.activity_yaohuo_order_list;
    }
    ...
    protected void initView() {
        ...
        setTopToolBar("要货单列表", R.mipmap.ic_left_light, "", 0, "");
        ...
        mAdapter = new YaohuoOrderListAdapter(mListInfo);
    ...
    private void getYaohuoOrderData() {
        ...
        mDanJuMainBean.JsonData.sheettype = Config.YwType.YH.toString();//单据类型
    ...
    protected void createOrderAfter() {
        startActivityForResult(new Intent(this,YaohuoOrderScanActivity.class),2);
    }
    ...
    protected void modifyAfter() {
        Intent intent = new Intent(this,YaohuoOrderScanActivity.class);
