...
public class SelectPandianTypeAdapter extends BaseAdapter {

    private List<PandianLeibieBeanResultItem> listInfo;
    private LayoutInflater inflater = null;
    private int itemClickPosition = -1;

    public SelectPandianTypeAdapter(Context context, List<PandianLeibieBeanResultItem> listInfo) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_typeId.setText(listInfo.get(position).getType_no());
