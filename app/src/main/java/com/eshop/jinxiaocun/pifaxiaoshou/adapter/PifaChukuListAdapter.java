...
public class PifaChukuListAdapter extends BaseAdapter {
    ...
    public PifaChukuListAdapter(List<DanJuMainBeanResultItem> listInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_pifa_chuku,parent,false);
        }
        ...
        TextView tvCustomerName = ViewHolderUtils.get(convertView, R.id.tv_customer_Name);
        ...
        tvCustomerName.setText(listInfo.get(position).getSupplyName());
