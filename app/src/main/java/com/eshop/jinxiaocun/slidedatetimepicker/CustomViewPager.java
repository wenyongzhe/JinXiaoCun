...
public class CustomViewPager extends ViewPager
{
    ...
    /**
     * When the login_user swipes their finger horizontally, dispatch
    ...
    public boolean dispatchTouchEvent(MotionEvent event)
    {
        switch (event.getAction())
        {
           ...
           case MotionEvent.ACTION_MOVE:
               ...
               {
                   // When the login_user is scrolling the ViewPager horizontally,
    ...
    /**
     * Determine whether the distance between the login_user's ACTION_DOWN
