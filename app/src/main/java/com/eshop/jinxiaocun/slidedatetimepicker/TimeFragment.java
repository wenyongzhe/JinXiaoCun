...
{
    /**
     * Used to communicate back to the parent fragment as the login_user
...
//        }
    ...
    /**
     * Create and return the login_user interface view for this fragment.
     */
    @Override
            ...
            Bundle savedInstanceState)
    {
        ...
        // the login_user toggles the AM/PM button. Only applies to 4.0.0 and 4.0.3.
     ...
     * is not invoked when the login_user toggles between AM/PM. But we need to be able
     * to detect this in order to dynamically update the tab title properly when
     * the login_user toggles between AM/PM.
     *
