        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    bundle.putString(Config.INTENT_EXTRA_KEY_QR_SCAN ,result.getText());

                    resultIntent.putExtras(bundle);
                    resultIntent.putExtra(Config.INTENT_EXTRA_KEY_QR_SCAN,result.getText());
                    CaptureActivity.this.setResult(Config.MESSAGE_CAPTURE_RETURN, resultIntent);
                    finish();
                } else {
...
//            Logger.d("saomiao",resultString);
            ...
            resultIntent.putExtra(Config.INTENT_EXTRA_KEY_QR_SCAN,resultString);
            resultIntent.putExtras(bundle);
            this.setResult(Config.MESSAGE_CAPTURE_RETURN, resultIntent);
        }
        CaptureActivity.this.finish();
    }
